<script lang="ts">
	...
	let questions: IQuestionBattery = [
		{
			id: 'l2-instruction-1',
			headingText: $LL['question']['l2-instruction-1']['heading'](),
			confirmText: $LL['question']['l2-instruction-1']['confirm'](),
			paragraphs: [get(LL).question['l2-instruction-1'].paragraphs[1]()],
			type: 'instruction',
			required: true
		}
	];
